...
class AddMaterialUsercase {
  final MaterialRepository repository;

  const AddMaterialUsercase({required this.repository});

  Future<Either<Failure, void>> callAdd(MaterialEntity entity) {
    return repository.addMaterial(entity);
  }
}
